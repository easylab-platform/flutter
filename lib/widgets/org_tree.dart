...
/// Persistent org → repo → branch tree used on the left of the Code tab.
/// The selected branch drives `store.openRepo`. Unlike the old bottom-sheet
...
/// repo to reveal its branches, a branch to open the repo in the browser.
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                ChatAvatar(org: o.org, repo: '', branch: o.org,
  ...
  Widget _repo(OrgNode o, RepoNode r, AppColors colors) {
    ...
    return Column(
      ...
      children: [
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: AppSpacing.xs),
                ChatAvatar(org: o.org, repo: r.repo, branch: '',
        ...
        if (open)
          for (final b in r.branches) _branch(o, r, b, colors),
      ],
    );
  }

  Widget _branch(OrgNode o, RepoNode r, BranchNode b, AppColors colors) {
    final text = textOf(context);
    final hasSession = b.session != null;
    final selected = store.codeRepo == r.repo && store.codeOrg == o.org;
    return InkWell(
      onTap: () {
        store.openCodeRepo(o.org, r.repo, b.branch);
      },
      child: Padding(
        padding: const EdgeInsets.symmetric(
        ...
        child: Row(
          children: [
            ...
            ChatAvatar(org: o.org, repo: r.repo, branch: b.branch,
                radius: 12),
            const SizedBox(width: AppSpacing.xs),
            Expanded(
              child: Text(
