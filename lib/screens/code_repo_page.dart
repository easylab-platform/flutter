...
/// Code tab — a repo is open (org/repo/branch given). Shows the file tree /
...
class _CodeRepoPageState extends State<CodeRepoPageWidget> {
  ...
  Future<void> _loadTree() async {
    ...
    await store.openRepo(widget.org, widget.repo, widget.branch);
    if (mounted) setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    final title = '${widget.org}/${widget.repo}'
        '${widget.branch.isNotEmpty ? '@${widget.branch}' : ''}';
    return SafeArea(
      child: Column(
        children: [
          Container(
